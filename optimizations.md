use chunks to subdivide the playing area: keep track of which people are located where and only search the local chunk for interactions instead of every player
